...
Learn how to add scripts, stylesheets, and other public assets to the Waterhole
layout.
...
Add stylesheets to the bundle using the
[`Stylesheet`](reference://Waterhole/Extend/Assets/Stylesheet.html) extender.
Waterhole will concatenate stylesheets onto the end of the bundle:
...
Add scripts to the bundle using the
[`Script`](reference://Waterhole/Extend/Assets/Script.html) extender. Waterhole
will concatenate scripts onto the end of the bundle:
...
If you're developing an [extension](./distribution.md), use the service
